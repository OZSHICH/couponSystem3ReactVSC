...
interface CompanyCouponItemProps {
  coupon: CouponModel;
}

function CompanyCouponItem(props: CompanyCouponItemProps): JSX.Element {
      ...
      <div className="flip-card-inner">
        ...
        <div className="flip-card-back">
          ...
          <div className="buttons">
            ...
            <Link className="link" to={`/companies/coupons/delete/${props.coupon.id}`}>
